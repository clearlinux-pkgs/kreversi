...
Version  : 24.08.0
Release  : 70
URL      : https://download.kde.org/stable/release-service/24.08.0/src/kreversi-24.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/kreversi-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/kreversi-24.08.0.tar.xz.sig
...
%setup -q -n kreversi-24.08.0
cd %{_builddir}/kreversi-24.08.0
pushd ..
cp -a kreversi-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724445184
mkdir -p clr-build
pushd clr-build
