...
Version  : 22.08.0
Release  : 41
URL      : https://download.kde.org/stable/release-service/22.08.0/src/kreversi-22.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/kreversi-22.08.0.tar.xz
...
%prep
%setup -q -n kreversi-22.08.0
cd %{_builddir}/kreversi-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661538852
mkdir -p clr-build
pushd clr-build
