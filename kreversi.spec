...
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/kreversi-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/kreversi-24.05.1.tar.xz.sig
...
%setup -q -n kreversi-24.05.1
cd %{_builddir}/kreversi-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718393588
mkdir -p clr-build
pushd clr-build
