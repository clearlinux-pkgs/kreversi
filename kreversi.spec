...
Version  : 22.08.2
Release  : 43
URL      : https://download.kde.org/stable/release-service/22.08.2/src/kreversi-22.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.2/src/kreversi-22.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.2/src/kreversi-22.08.2.tar.xz.sig
...
%prep
%setup -q -n kreversi-22.08.2
cd %{_builddir}/kreversi-22.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665710533
mkdir -p clr-build
pushd clr-build
