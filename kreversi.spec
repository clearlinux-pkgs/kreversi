...
Source0  : https://download.kde.org/stable/release-service/23.04.2/src/kreversi-23.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.2/src/kreversi-23.04.2.tar.xz.sig
...
%prep
%setup -q -n kreversi-23.04.2
cd %{_builddir}/kreversi-23.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686510287
mkdir -p clr-build
pushd clr-build
